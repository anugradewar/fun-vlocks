...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/twinkling-text","version":"0.1.0","title":"Twinkling Text","category":"widgets","icon":"marker","description":"Create a twinkling point beside the text.","example":{},"supports":{"__experimentalBorder":{"color":true,"radius":true,"width":true,"style":true},"html":false,"color":{"background":true,"gradients":true,"text":true},"spacing":{"margin":true,"padding":true,"blockGap":false},"typography":{"fontSize":true}},"attributes":{"alignment":{"type":"string","default":"left"},"columnGap":{"type":"string","default":0},"dotColor":{"type":"string"},"dotSize":{"type":"string","default":"8px"},"justifyContent":{"type":"string","default":"left-aligned"},"text":{"type":"string"}},"textdomain":"twinkling-text","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["twinkling-text/style-index"], () => (__webpack_require__("./src/twinkling-text/index.js")))
